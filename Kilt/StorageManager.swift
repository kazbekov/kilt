...
struct StorageManager {
    ...
    static func saveRequestAvatar(key: String, data: NSData, completion: (url: NSURL?, error: NSError?) -> Void) {
        ref.child("requests/\(key).jpg").putData(data, metadata: nil) { metadata, error in
